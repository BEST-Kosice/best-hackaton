export const content = {
    ...
    hero: {
        ...
        countdownDate: "2026-04-05T22:00:00+02:00",
    ...
    participants: {
        ...
        schedule: {
            ...
            friday: [
                { time: "13:00", activity: "Registrácia a welcome coffee" },
                { time: "14:00", activity: "Oficiálne otvorenie a privítanie" },
                { time: "15:00", activity: "Sprint 1" },
                { time: "18:00", activity: "Večera" },
                { time: "19:00", activity: "Stand-up #1" },
                { time: "20:00", activity: "Večerný program" },
                { time: "21:00", activity: "Sprint 2" },
            ],
            saturday: [
                { time: "07:00", activity: "Raňajky" },
                { time: "08:00", activity: "Stand-up #2" },
                { time: "09:00", activity: "Sprint 3" },
                { time: "13:00", activity: "Obed" },
                { time: "14:00", activity: "Wrap-up" },
                { time: "15:00", activity: "Deadline a prezentácie" },
                { time: "17:00", activity: "Vyhodnotenie a ceny" }
            ],
        },
